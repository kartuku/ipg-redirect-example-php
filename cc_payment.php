<!--Example Credit Card payment using redirect API-->
<html>
    <body>
        ...
        $form = $redirectApi->generateCcPaymentForm($payment, 'order-form'); // generate form with id 'order-form', usually the form is invisble to user
